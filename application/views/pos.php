   ...
   <div class="row">
      ...
      <div class="col-md-5 left-side">
         ...
         <div class="col-sm-12" style="margin-top: 5%">
            <select class="js-select-options form-control" id="typedoc">
         ...
         <input type="type" hidden="" id="lastbill">
         ...
         <div class="footer-section">
            ...
            <button type="button" onclick="getlastbill()" class="btn btn-green col-md-6 flat-box-btn" data-toggle="modal" data-target="#AddSale"><h5 class="text-bold"><?=label('PAYEMENT');?></h5></button>
            <button type="button" onclick="CloseTable()" class="btn btn-green col-md-12 flat-box-btn" style="margin-top: 3%; background: #0DC143"><h5 class="text-bold" >LIBERAR MESA</h5></button>
         </div>
...
function getlastbill(){
   ...
   /*var test = ("<?php echo site_url('pos/getLastBill')?>");
   console.log(test);*/

   $.ajax({
      url : "<?php echo site_url('pos/getLastBill')?>/",
      type: "GET",
      success: function(data)
      {
        console.log(data);
...
function saleBtn(type) {
   var typedoc = $('#typedoc').find('option:selected').val();
...
<div class="modal fade" id="AddCustomer" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
 <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart('customers/add?pos=pos'); ?>
      <div class="modal-body">
            <div class="form-group">
           ...
           <div class="form-group">
             ...
             <input type="text" name="fechanac" class="form-control" id="fechanac" placeholder="Fecha de nacimiento">
           </div>
           <div class="form-group">
...
//Testing 
  function addCustomerForm(){
    ...
    $('#addCustomerForm').submit(function(e){
     ...
     var nit = $('#nit').val();
     $.ajax({
      url : "<?php echo site_url('customers/verifyNit?val='+nit)?>/",
      type: "GET",
      success: function(data) {
        console.log(data);
      }
    ...
    /*$.ajax({
      url : "<?php echo site_url('customers/verifyNit')?>/",
      type: "POST",
      success: function(data) {
        console.log(data);
      }
