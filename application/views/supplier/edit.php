   ...
   <div class="row" style="margin-top:100px;">
      ...
      <?php echo form_open_multipart('suppliers/edit/'.$supplier->id); ?>
           ...
           <div class="form-group">
            ...
            <input type="text" maxlength="50" Required name="nit" value="<?=$supplier->nit;?>" class="form-control" id="nit" placeholder="NIT">
           </div>
           <div class="form-group">
            <label for="direccion">NIT</label>
            <input type="text" maxlength="200" Required name="direccion" value="<?=$supplier->direccion;?>" class="form-control" id="direccion" placeholder="Dirección">
           </div>
           <div class="form-group">
