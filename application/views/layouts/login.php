...
<html >
  <head>
    ...
    <style media="screen">
    body {
            background: url(<?=base_url()?>assets/img/gb-coffeemate.jpeg) no-repeat center center fixed;
     ...
     <div class="modal fade" id="login-modal" tabindex="-1" role="dialog">
       <div class="modal-dialog">
            <div class="loginmodal-container">
               <?php if($this->setting->logo){ ?><img src="<?=base_url()?>files/Setting/<?=$this->setting->logo;?>" alt="logo"  style=' max-width: 200px; margin: 0 auto'><?php } else { ?><img src="<?=base_url()?>assets/img/logo.png" alt="logo"><?php } ?>
