...
<html lang="en">
   <head>
      ...
      <link rel="icon" href="<?=base_url();?>/coffee.ico?v=2" type="image/x-icon">
      ...
      <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
         <div class="container-fluid">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="#"><?php if($this->setting->logo){ ?><img src="<?=base_url()?>files/Setting/<?=$this->setting->logo;?>" alt="logo"  style='max-width: 200px;margin-top:5px;'><?php } else { ?><img src="<?=base_url()?>assets/img/logo.png" alt="logo"><?php } ?></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
               <ul class="nav navbar-nav">
                 ...
                 <?php if($this->user->role === "admin"){?><li class="flat-box"><a href="<?=base_url()?>stats"><i class="fa fa-line-chart"></i> <span class="menu-text"><?=label("Reports");?></span></a></li><?php } ?>
                 <?php } ?>
               </ul>
