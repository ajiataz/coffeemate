          ...
          <tbody>
             <?php foreach ($customers as $customer):?>
              <tr>
                 ...
                 <td><?=$customer->fechanac->format('d/m/Y');?></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
           ...
           <div class="form-group">
             ...
             <input type="text" name="nit" maxlength="50" Required class="form-control" id="nit" placeholder="NIT">
           </div>
           <div class="form-group">
             <label for="direccion">Dirección</label>
             <input type="text" name="direccion" maxlength="50" Required class="form-control" id="direccion" placeholder="Dirección">
           </div>
           <div class="form-group">
             <label for="fechanac">Fecha de nacimiento</label>
             <input type="text" name="fechanac" maxlength="50" Required class="form-control" id="fechanac" placeholder="Fecha de nacimiento">
           </div>
