...
class Pos extends CI_Controller
{
   ...
   public function showticket($num, $subtotal, $totalitems, $waiter,$cuenta)
   {
      ...
      */
      ...
      $i = 1;
      foreach ($posales as $posale) {
           $ticket .= '<tr><td style="text-align:left; width:180px; font-size:30px;">' . $posale->name . '<br><span style="color:#000; font-size:30px;">'.$posale->options.'</span></td><td style="text-align:center; width:50px; font-size:30px">' . $posale->qt . '</td></tr>';
           $i ++;
      }
