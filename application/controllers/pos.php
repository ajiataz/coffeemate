...
class Pos extends CI_Controller
{
    ...
    public function AddNewSale($type)
    {
        ...
        foreach ($posales as $posale) {
            ...
            $ticket .= '<table> <tr> <td style="width: 80px; text-align: center; font-size: 18px; font-weight: 700;">' . $posale->qt . '</td> <td style="width: 210px; font-size: 18px; font-weight: 700;">' . $posale->name . '</td> <td style="margin-left: 30px; font-size: 18px; font-weight: 700;">'.$this->setting->currency.' '.$posale->price.'</td> </tr> </table>';
            $i ++;
        }
