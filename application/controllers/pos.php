...
class Pos extends CI_Controller
{
    ...
    public function AddNewSale($type)
    {
        ...
        $tbltd = '';
          ...
          $td9 = '<tr><td style="height: 25px;">&nbsp;</td></tr><tr><td style="height: 25px;">&nbsp;</td></tr><tr><td style="height: 25px;">&nbsp;</td></tr><tr><td style="height: 25px;">&nbsp;</td></tr><tr><td style="height: 25px;">&nbsp;</td></tr><tr><td style="height: 25px;">&nbsp;</td></tr><tr><td style="height: 25px;">&nbsp;</td></tr><tr><td style="height: 35px;">&nbsp;</td></tr>';
   ...
   public function showticket($num, $subtotal, $totalitems, $waiter,$cuenta)
   {
      ...
      $i = 1;
      foreach ($posales as $posale) {
           $ticket .= '<tr><td style="text-align:left; width:180px;">' . $posale->name . '<br><span style="font-size:12px;color:#000">'.$posale->options.'</span></td><td style="text-align:center; width:50px;">' . $posale->qt . '</td><td style="text-align:right; width:70px;font-size:14px; ">' . $this->setting->currency . ' ' . number_format((float)($posale->qt * $posale->price), $this->setting->decimals, '.', '') . '</td></tr>';
           $i ++;
      }
